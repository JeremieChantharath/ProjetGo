...
- **Racine** : Documentation et ressources (`CHECKLIST.md`, `docs/`, `screenshots/`)
- **GoGame/** : Application principale avec tous les fichiers de développement
- **Toujours exécuter les commandes depuis `GoGame/`** : `cd GoGame` puis `npm start`
